...
from plasticity_solver_wholespecimen.plasticity_simu import run_simulation_bc_vtu_fast
...
if femu == 1:
    ...
    def my_solver(run_cfg: Dict[str, Any]) -> Tuple[np.ndarray, pv.MultiBlock]:
        """
        This FEM solver takes now in entry how the boundary conditions are applied.
        """
    ...
    Bounds = {
        ...
        "ux_up": (-0.01, 0.01), "uy_up": (0.0001, 0.05), "ux_down": (-0.01, 0.01), "uy_down": (-0.05, -0.0001),
    }
