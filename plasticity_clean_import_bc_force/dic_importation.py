...
def process_csv_series_to_cad_mesh(
    ...
    fill_outside_with_nearest: bool = True,
) -> None:
    """Projection d'une série temporelle de CSV sur un maillage CAD global

    par interpolation linéaire (VTK Probe Filter).
    ...
    expérimentales, puis interpole linéairement et sauvegarde chaque pas de temps sur le CAD global.
